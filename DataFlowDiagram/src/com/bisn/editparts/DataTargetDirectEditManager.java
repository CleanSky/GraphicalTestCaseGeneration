...
public class DataTargetDirectEditManager extends DirectEditManager {
	Font scaledFont;
	protected VerifyListener verifyListener;
	protected DataTargetFigure nodeFigure;
	 ...
	 */
	public DataTargetDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator) {
		super(source, editorType, locator);
		//    	this.nodeFigure = nodeFigure;
		this.nodeFigure = (DataTargetFigure) source.getFigure();
	}
...
//	}
	...
	protected void initCellEditor() {
		...
		getCellEditor().setValue(((DataTarget) getEditPart().getModel()).getName());
