...
public class DataSourceCellEditorLocator implements CellEditorLocator {
	private DataSourceFigure nodeFigure;

	/**
	 * Creates a new ActivityCellEditorLocator for the given Label
	 * @param nodeFigure the Label
	 */
	public DataSourceCellEditorLocator(DataSourceFigure nodeFigure) {
