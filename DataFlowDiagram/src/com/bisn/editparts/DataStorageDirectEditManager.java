...
public class DataStorageDirectEditManager extends DirectEditManager {
	Font scaledFont;
	protected VerifyListener verifyListener;
	protected DataStorageFigure nodeFigure;
	 ...
	 */
	public DataStorageDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator) {
		super(source, editorType, locator);
		//    	this.nodeFigure = nodeFigure;
		this.nodeFigure = (DataStorageFigure) source.getFigure();
	}
...
//	}
	...
	protected void initCellEditor() {
		...
		getCellEditor().setValue(((DataStorage) getEditPart().getModel()).getName());
