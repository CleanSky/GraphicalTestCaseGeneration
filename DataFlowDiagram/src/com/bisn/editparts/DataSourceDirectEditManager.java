...
public class DataSourceDirectEditManager extends DirectEditManager {
	Font scaledFont;
	protected VerifyListener verifyListener;
	protected DataSourceFigure nodeFigure;
	 ...
	 */
	public DataSourceDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator) {
		super(source, editorType, locator);
		//    	this.nodeFigure = nodeFigure;
		this.nodeFigure = (DataSourceFigure) source.getFigure();
	}
...
//	}
	...
	protected void initCellEditor() {
		...
		getCellEditor().setValue(((DataSource) getEditPart().getModel()).getName());
