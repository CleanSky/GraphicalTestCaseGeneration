...
public class DataProcessDirectEditManager extends DirectEditManager {
	Font scaledFont;
	protected VerifyListener verifyListener;
	protected DataProcessFigure nodeFigure;
	 ...
	 */
	public DataProcessDirectEditManager(GraphicalEditPart source, Class editorType, CellEditorLocator locator) {
		super(source, editorType, locator);
		//    	this.nodeFigure = nodeFigure;
		this.nodeFigure = (DataProcessFigure) source.getFigure();
	}
...
//	}
	...
	protected void initCellEditor() {
		...
		getCellEditor().setValue(((DataProcess) getEditPart().getModel()).getName());
