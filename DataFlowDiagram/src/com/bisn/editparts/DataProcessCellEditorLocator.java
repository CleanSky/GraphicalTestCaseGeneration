...
public class DataProcessCellEditorLocator implements CellEditorLocator {
	private DataProcessFigure nodeFigure;

	/**
	 * Creates a new ActivityCellEditorLocator for the given Label
	 * @param nodeFigure the Label
	 */
	public DataProcessCellEditorLocator(DataProcessFigure nodeFigure) {
