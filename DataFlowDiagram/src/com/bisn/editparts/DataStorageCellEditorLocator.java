...
public class DataStorageCellEditorLocator implements CellEditorLocator {
	private DataStorageFigure nodeFigure;

	/**
	 * Creates a new ActivityCellEditorLocator for the given Label
	 * @param nodeFigure the Label
	 */
	public DataStorageCellEditorLocator(DataStorageFigure nodeFigure) {
